...
class customElement extends PolymerElement {
    ...
    static get template() {
        ...
        <div>
        <button on-click="togglePlayFunction" id="myButton"><img src='./play.svg'  height='50px' width='50px'></button>
        <input id="seekbar" type="range" min="0" max="100" on-click="seekBar"></input>
        <button id="myButton1" on-click="toggleMuteFunction"><img src='./mute.png'  height='50px' width='50px'></button>
        </div>`;
    }
